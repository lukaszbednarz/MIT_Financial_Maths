...
JDSU <- getYahooData("VIAV", start=date.start, end=date.end)
...
dir.create(paste(getwd(), "/Learning/MIT_Financial_Maths/case-studies/Case_Study_1", sep=""), recursive = TRUE)

setwd(paste(getwd(), "/Learning/MIT_Financial_Maths/case-studies/Case_Study_1", sep=""))
